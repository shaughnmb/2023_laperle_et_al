...
dir <- "/Users/bells/Library/CloudStorage/Box-Box"
datadir <- paste0(dir,"/20221013_iNPC_noT12") # directory to save files generated
sourcedir <- paste0(dir,"/20220419_inpc_outs_copy") # save Cellranger outs here
...
DimPlot(s.integrated, reduction = "umap", label = FALSE, split.by = "Lot") + 
  NoLegend() + 
  ggtitle(paste0(ident_res))
...
DimPlot(s.integrated, reduction = "umap", label = TRUE, split.by = "Lot") + 
  NoLegend() + 
  ggtitle(paste0(ident_res))
hirestiff(paste0(prefixPCres,"_UMAP","_by_","lot","_hires.tiff"))
lowrestiff(paste0(prefixPCres,"_UMAP","_by_","lot","_lowres.tiff"))
